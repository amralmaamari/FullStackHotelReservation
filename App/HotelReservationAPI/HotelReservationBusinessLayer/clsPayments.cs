...
namespace Hotel_Business
{
    public class clsPayments
    {
        ...
        public clsPaymentTypes PaymentTypesInfo { get; set; }
        ...
        public clsPayments(PaymentsDTO payments, enMode mode = enMode.AddNew)
        {
            ...
            BookingInfo = clsBooking.GetBookingInfoByID(BookingID);

            this.PaymentTypeID = payments.PaymentTypeID;
            PaymentTypesInfo = clsPaymentTypes.GetPaymentTypesInfoByID(PaymentTypeID);

            this.PaymentStatusID = payments.PaymentStatusID;
            PaymentStatusInfo = clsPaymentStatus.GetPaymentStatusInfoByID(PaymentStatusID);
        ...
        public static clsPayments GetPaymentsInfoByBookingID(int BookingID)
        {
            PaymentsDTO paymentsDTO = clsPaymentsData.GetPaymentsInfoByBookingID(BookingID);
