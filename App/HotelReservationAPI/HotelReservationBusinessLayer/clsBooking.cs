...
namespace Hotel_Business
{
    public class clsBooking
    {
        ...
        public clsBooking(BookingDTO booking, enMode mode = enMode.AddNew)
        {
            ...
            BookingStatusInfo = clsBookingStatus.GetBookingStatusInfoByID(BookingStatusID);
        ...
        {
            return clsBookingData.GetBookingDetailsByID(BookingID);
        }

        public static List<BookingDTOS.BookingDetailsDTO> GetBookingDetailsByUserID(int UserID)
        {
            return clsBookingData.GetBookingDetailsByUserID(UserID);
        }
